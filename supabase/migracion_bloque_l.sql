-- =========================================================
-- MIGRACIÓN — Bloque L: servicio "Adicional" con concepto y valor libres al
-- agendar una cita (interno y desde el usuario de la clienta).
-- Ejecutar en: Supabase Dashboard > SQL Editor (una sola vez)
-- =========================================================

alter table public.citas
  add column if not exists adicional_concepto text,
  add column if not exists adicional_valor numeric(12,2) check (adicional_valor is null or adicional_valor >= 0);
